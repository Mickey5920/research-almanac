...
<p align="center">v0.12.0 · Node.js 22+ · 本地计算 · 中英文离线 HTML · MIT</p>

![科研黄历中文界面：交叉研究、阶段适配、每日行动与投稿择日](assets/screenshots/almanac.v0120.zh-CN.png)
...
| 六类概览 | 人文、社科、理学、工学、农学、医学，随时切换查看 |
| 可执行的每日安排 | 执行步骤、产物、核查点、轻量版本、卡住时与有余力时的选择 |
| 多样的今日节奏 | 梳理、推进、核查、交流、收口、恢复、轻读、接续，随日期和学科变化 |
| 项目任务安排 | 按时长、依赖、截止和可用时段安排任务，避开已定事件 |
| 一周全览 | 按个人方向与方法查看七天安排，也可切回六类概览；点击日期进入当天 |
| 经典原文与解释 | 八卦原文、章节、白话解释与当日工作的现代联系 |
| 中英文切换 | 界面与内置建议离线切换，保留用户原文与古文 |
| 本次与往期 | 从本地保存的记录切换科研黄历和原有投稿报告 |

展开一项安排，可以看到从哪里开始、如何推进、留下什么，以及时间有限或暂时卡住时还能做的一小步。

![展开执行清单：具体步骤、产物、核查点与轻量版本](assets/screenshots/almanac-detail.v0120.zh-CN.png)

![整周安排：个人方向与研究方法的每日重点和产物](assets/screenshots/almanac-week.v0120.zh-CN.png)
...
![英文科研黄历，展示同一份保存的示例记录](assets/screenshots/almanac.v0120.en.png)
