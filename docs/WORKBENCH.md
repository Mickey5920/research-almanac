...
0.12.0 增加按专业、方法与阶段生成的个人安排，默认展示“我的研究安排”，保留六类概览、双语离线报告与投稿择日。支持 38 个方向、12 种方法、9 个阶段及自填、交叉方向。内容与匹配细则见[研究画像指南](../references/research-profile.md)。

0.13.0 默认展开每日执行清单，点击概览学科或整周单元格可直达对应详情；增加六学科 × 九类操作指南与更完整的本周关注。阅读、画图、总结、思考、复现、实验、代码、写作和讨论均有步骤、产物及核查点，按节奏、方法和阶段展示。
