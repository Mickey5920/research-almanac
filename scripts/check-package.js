...
for(const p of ['scripts/weekly.js','scripts/weekly-html.js','schemas/weekly-input.schema.json','schemas/weekly-output.schema.json','web/weekly.html','web/weekly.css','web/weekly.js','data/research-routines.json','data/research-profiles.json','scripts/research-profile.js','scripts/research-activities.js','data/research-activities.json','references/research-profile.md','examples/weekly-personalized.json','examples/weekly-creative.json','data/holidays-cn-2026.json','docs/RESEARCH-ALMANAC.md','references/submission-workflow.md','examples/weekly.json','examples/weekly-project.json','assets/screenshots/almanac.v0130.zh-CN.png','assets/screenshots/almanac.v0130.en.png'])if(!existsSync(join(root,p)))throw new Error('Missing '+p);
