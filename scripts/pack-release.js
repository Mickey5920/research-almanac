...
const target=resolve(root,'dist','zhouyi-paper-submit-advisor');
if(existsSync(target))throw new Error('Release folder exists; preserve it and choose a new version before exporting again.');
const allowed=['SKILL.md','README.md','README.zh-CN.md','LICENSE','THIRD_PARTY_NOTICES.md','package.json','package-lock.json','.gitignore','.gitattributes','.github','agents','assets','config','data','docs','examples','references','schemas','scripts','tests'];
